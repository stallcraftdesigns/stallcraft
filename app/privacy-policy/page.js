            ...
            <Container maxWidth="lg" sx={{ py: 10 }}>
                ...
                <Box component="div" sx={{ fontFamily: "var(--font-syne)", color: "grey.700", mb: 5 }}>
                    ...
                    <ul>
                        ...
                        <li><strong>Email Address:</strong> To respond to your inquiries and keep you updated.</li>
                        <li><strong>Phone Number:</strong> To contact you if needed.</li>
                        <li><strong>Message:</strong> Any details you share regarding your stall or shop requirements.</li>
                    </ul>
                </Box>
                ...
                <Box component="div" sx={{ fontFamily: "var(--font-syne)", color: "grey.700", mb: 5 }}>
                    <Typography fontSize={20} sx={{ fontFamily: "var(--font-syne)", color: "grey.700", }}>
                        The data you provide is used strictly for business communication and improving our services. Specifically, we use your information to:
                    </Typography>
                    <ul>
                ...
                <Typography fontSize={20} sx={{ fontFamily: "var(--font-syne)", color: "grey.700", mb: 5 }}>
                    If you have any questions regarding our privacy practices, you can reach us via our contact page. We are committed to resolving any concerns promptly.
                </Typography>
            </Container>
        </Layout>
    );
